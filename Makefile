...
strings/strings_utils3.c strings\slashes_path.c \
syntaxes/check_syntaxes.c \
wildcard/handle_wild_card.c wildcard\get_folders.c wildcard/check_if_same_wild.c \
